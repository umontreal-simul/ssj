...
public class HistogramChartToLatex {
   ...
   /*
    * 
    * return tex file for an histogram by using a Scaledhistogram object and can
    * add the polygonal histogram if the flag 'poly' is false.
    * 
    * @param scaledH a ScaledHistogram object
    * 
    * @param poly Plots a polygonal (piecewise linear) interpolation of the
    * histogram if 'poly=true'
    * 
    * @param hist Plot the histogram if 'hist=true'
    * 
    * If 'poly=true' and 'hist=false', the method plot only the Polygonal
    * interpolation of the histogram If 'poly=false' and 'hist=true', the method
    * plot only the Histogram 'poly=true' and 'hist=true', the plot the histogram
    * and the the polygonal We need to plot some things. If 'poly=false' and
    * 'hist=false', the method plot the histogram only.
    * 
    * 
    */
    ...
    * If 'poly=true' and 'hist=false', the method plot only the Polygonal
    * interpolation of the histogram If 'poly=false' and 'hist=true', the method
    * plot only the Histogram 'poly=true' and 'hist=true', the method plot the
    * histogram and the the polygonal We need to plot some things. If 'poly=false'
    * and 'hist=false', the method plot the histogram only.
    * 
    * 
    */
    ...
    * 
    * @param name The name of the generate tex file. You can find it in your
    * current working Directory you must change this path
    * 
