...
public abstract class DensityEstimator {
	...
	/**
	 *  Computes all traits for the density estimator that
	 * are specified in the list \a traitList. The density estimator itself is
	 * constructed from the observations in \a data and the evaluation points to
	 * compute the traits are given in \a evalPoints. Possible choices of traits are
