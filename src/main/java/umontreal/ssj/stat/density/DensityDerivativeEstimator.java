 ...
 * see \ref umontreal.ssj.stat.density.DEKernelDensity. Such an estimator is
 * used to find the \f$r\f$-th derivative of an unknown density based on \f$n\f$
 * observations \f$x_0,x_1,\dots,x_{n-1} \f$ of an underlying model. It is of
 * the form
 * 
 ...
 * and evaluate DDEs. Note that sufficient smoothness of the kernel function
 * \f$K\f$ as well as of the unknown density \f$f\f$ is required.
 * 
...
public abstract class DensityDerivativeEstimator extends DensityEstimator {
    ...
    * 
    * 
    * @param r     the order of the functional. Has to be even.
    * @param sigma the standard deviation of the normal density considered.
