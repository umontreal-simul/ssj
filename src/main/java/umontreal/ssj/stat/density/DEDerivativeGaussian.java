 ...
 * 
 * where \f$H_r\f$ denotes the probabilist's Hermite polynomial of order \f$r\f$
 * and \f$\phi\f$ denotes the standard normal density.
 * 
 * This class also offers static methods so that the user can simply evaluate
 * the density based on a set of observations without having to construct a KDE.
 *
 */
...
public class DEDerivativeGaussian extends DensityDerivativeEstimator {
   ...
   /**
    * Constructs a DDE with a Gaussian kernel function of order \a order based on
   ...
   /**
    * Constructs a DDE with a Gaussian kernel function with bandwidth \a h based on
    * the observations \a data.
    * 
    * @param h    the bandwidth.
    * @param data the observations.
   ...
   /**
    * Evaluates the DDE at all the points in \a evalPoints and the resulting values
   ...
   // STATIC METHODS
   /**
    * Evaluates the DDE of order \a order with bandwidth \a h which is defined by
    * the observations \a data at the evaluation point \a x.
    * 
    * @param x     the evaluation point.
   ...
   /**
    * Evaluates the DDE of order \a order with bandwidth \a h which is defined by
    * the observations \a data at each of the evaluation points in \a evalPoints.
    * 
    * @param evalPoints the evaluation points.
    * @param order      the order of the DDE.
    * @param h          the bandwidth.
    * @param data       the observations.
    * @return The DDE defined by the above parameters evaluated at each point in \a
    *         evalPoint.
    */
    ...
    * bandwidth \a h at the points from \a evalPoints. The independent realizations
    * are passed via the 2-dimensional \f$m\times n\f$ array \a data, where \f$n\f$
    ...
    * corresponds to the point of \a evalPoints at which the DDE was evaluated.
    * 
    * @param evalPoints the evaluation points.
    * @param order      the order of the DDE.
    * @param h          the bandwidth.
