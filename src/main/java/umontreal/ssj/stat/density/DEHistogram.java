 ...
 * 
 * This class also offers several static methods so that the user can simply
 * evaluate the density based on a set of observations, a `TallyHistogram` or a
 * `ScaledHistogram` without having to construct a histogram object.
 * 
