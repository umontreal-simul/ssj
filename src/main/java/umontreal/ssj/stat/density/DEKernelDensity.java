 ...
 * \f$x_0,\dots, x_{n-1}\f$, and to evaluate it at a single point or at a set of
 * selected evaluation points. The observations can be collected data or
 * realizations of a \ref umontreal.ssj.mcqmctools.MonteCarloModelDouble, for
 * instance.
 * 
 ...
 * 
 *         This class also offers static methods so that the user can simply
 *         evaluate the density based on a set of observations without having to
 *         construct a KDE.
 *
 */
...
public class DEKernelDensity extends DensityEstimator {
    ...
    * 
    * @param kernel the kernel density function.
    */
    ...
    * 
    * @param kernel the kernel density function to be used.
    */
    ...
    * are considered negligible.
    * 
    * @param eps the threshold-level for evaluation.
    */
    ...
    * corresponds to the point of \a evalPoints at which the KDE was evaluated.
    * 
    * For this method the kernel function \f$K\f$ is assumed to be unimodal, i.e.
    * increasing and then decreasing, and that the points in \a evalPoints are
