...
/**
 * Represents a data table which has a name, a number of observations (rows), a
 * number of fields (columns), an array that contains the names (identifiers) of
 * the fields, and a two-dimensional array that contains the data. Methods are
 * available to format the table, or selected columns of the table, or to
 * produce LaTeX code to draw a plot of one field against another field using
 * the pgfplot LaTeX package. These types of tables can also be passed to other
...
public class PgfDataTable {
   ...
   /**
    * Constructs a table with the given table name, array of field names, and data
    * observations.
    * 
    * @param tableName  Name (descriptor) of the table.
    * @param tableLabel A label (very short name) for the table, to be used in
    *                   plots to identify curves.
    ...
    * and the data points (observations) in the following rows. This format can be
    * used directly by the pgfplot package in Latex.
    * 
    ...
    * (i.e., two selected fields), specified by `j1` and `j2`. Note that the fields
    * are numbered from 0.
    * 
   ...
   /**
    * Similar to `formatTableTwoFields`, but outputs complete LaTeX code in an
    * appropriate format that adds a curve of the field `j2` against field `j1`
    * with the pgfplot package.
    * 
    * @param `j1`        number of first selected field.
    * @param `j2`        number of second selected field.
    * @param plotoptions is used to specify the options of addplot in the pgfplot
    *                    package: <tt>addplot[plotoptions]</tt>
   ...
   /**
    * Returns a `String` that contains a complete `tikzpicture` for the `pgfplot`
    * package, showing the field `j2` against field `j1`.
    * 
    * @param title       is the title of the plot.
    * @param j1          first selected field.
    * @param j2          second selected field.
    * @param loglog      says if we want a log-log plot (true) or not (false).
    * @param plotoptions is used to specify the options of addplot:
    *                    <tt>addplot[plotoptions]</tt>
    * @return LaTeX code as a string.
    */
   public String drawPgfPlotSingleCurve(String title, String axistype, String xaxis, String yaxis, int logbasis,
         String axisoptions, String plotoptions) {
      int j1 = Arrays.asList(fields).indexOf(xaxis);
      int j2 = Arrays.asList(fields).indexOf(yaxis);
      return drawPgfPlotSingleCurve(title, axistype, j1, j2, logbasis, axisoptions, plotoptions);
   }

   /**
    * Similar to the previous one.
    */
   public String drawPgfPlotSingleCurve(String title, String axistype, int j1, int j2, int logbasis, String axisoptions,
         String plotoptions) {
      StringBuffer sb = new StringBuffer("");
   ...
   /**
    * Returns a string that contains a complete tikzpicture for the pgfplot
    * package, showing the field j2 against field j1, for all the curves that
    * belong to listCurves.
    * 
    * 
    * @param title       is the title of the plot.
    * @param j1          first selected field.
   ...
   /**
    * Similar to @ref formatPgf, but outputs complete LaTeX code in an appropriate
    * format that adds a curve of the three fields j3, j2, and j1 with the pgfplot
    * package.
    * 
    * @param j1          first selected field.
    * @param j2          second selected field.
    ...
    * @return
    */
   public String drawPgfPlotSingleCurve(String title, String axistype, int j1, int j2, int j3, int logbasis,
         String axisoptions, String plotoptions) {
      StringBuffer sb = new StringBuffer("");
      sb.append("  \\begin{tikzpicture} \n");
      sb.append("    \\begin{" + axistype + "}[ \n");
