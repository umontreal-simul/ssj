...
public class RandomVariateGenInt extends RandomVariateGen {
   ...
   /**
    * Generates a random number (an integer) from the discrete distribution
    * contained in this object. By default, this method uses inversion by calling
    * the `inverseF` method of the distribution object. Alternative generating
    * methods are provided in subclasses.
    * 
   ...
   /**
    * Generates `n` random numbers from the discrete distribution contained in this
    * object. The results are stored into the array `v`, starting from index
    * `start`. By default, this method calls #nextInt() `n` times, but one can
    * reimplement it in subclasses for better efficiency.
    * 
   ...
   /**
    * Generates `n` random numbers from the discrete distribution contained in this
    * object, and returns them in a new array of size `n`. By default, this method
    * calls #nextInt() `n` times, but one can override it in subclasses for better
    * efficiency.
    * 
   ...
   /**
    * Returns the @ref umontreal.ssj.probdist.DiscreteDistributionInt used by this
    * generator.
    * 
