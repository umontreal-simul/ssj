 ...
 * distribution. The density is (see, e.g., @cite tJOH95a&thinsp; p. 299):
 * 
 * @anchor REF_randvar_CauchyGen_eq_fcauchy @f[ f (x) =
 *         \frac{\beta}{\pi[(x-\alpha)^2 + \beta^2]}, \qquad\mbox{for } -\infty<
 *         x < \infty, \tag{fcauchy} @f] where @f$\beta> 0@f$.
 *
...
public class CauchyGen extends RandomVariateGen {
   ...
   /**
    * Creates a Cauchy random variate generator with parameters @f$\alpha=0 @f$
