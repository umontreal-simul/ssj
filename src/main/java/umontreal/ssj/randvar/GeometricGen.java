 ...
 * 
 * @anchor REF_randvar_GeometricGen_eq_fgeom @f[ p(x) = p(1-p)^x \mbox{ for }
 *         x=0,1,2,…, \tag{fgeom} @f] where @f$0\le p\le1@f$. Random variates
 *         are generated by calling inversion on the distribution object.
 *
...
public class GeometricGen extends RandomVariateGenInt {
   ...
   /**
    * Creates a geometric random variate generator with parameter @f$p@f$, using
    * stream `s`.
    */
