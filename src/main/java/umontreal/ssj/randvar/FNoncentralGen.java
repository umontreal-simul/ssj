 ...
 * 
 * @f$\lambda> 0@f$, and @f$Y@f$ is a chi-square random variable (statistically
 *             independent of @f$X@f$) with @f$\nu_2>0@f$ degrees of freedom,
 *             then @f[ F’ = \frac{X/\nu_1}{Y/\nu_2} @f] has a
 *             noncentral @f$F@f$-distribution.
 *
...
public class FNoncentralGen extends RandomVariateGen {
   ...
   /**
    * Creates a *noncentral-F* random variate generator using noncentral chi-square
    * generator `ncgen` and chi-square generator `cgen`.
    */
