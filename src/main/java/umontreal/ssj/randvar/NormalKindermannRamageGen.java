 ...
 * UNURAN @cite iLEY02a&thinsp;. It includes the correction of the error in the
 * original *Kindermann-Ramage* method found by the authors in
 * 
 * @cite rTIR04a&thinsp;.
 *
      ...
      if (U < 0.884070402298758) {
         ...
         do {
            ...
            t = XI - 0.630834801921960 * Math.min(V, W);
               ...
               * Math.abs(z) > (PIhochK * Math.exp(t * t / (-2.)) - 0.180025191068563 * (XI - Math.abs(t))));
         X = (z < 0) ? t : -t;
      }
