 ...
 * numbers.
 *
 * The generic classes  @ref RandomVariateGen and
 * @ref RandomVariateGenInt permit one to construct a
 ...
 * construct a  @ref RandomVariateGen object with the
 ...
 * `RandomVariateGen.nextDouble` method as many times as
 * needed. For discrete distributions over the integers, one can construct a
 * @ref RandomVariateGenInt object containing the
 ...
 * @ref RandomVariateGen or
 * @ref RandomVariateGenInt. Such classes are provided
 ...
 * @ref NormalGen, extends
 * @ref RandomVariateGen directly and provides normal
 * random variate generators based on inversion, so it does the same thing as
 * using  @ref RandomVariateGen with the normal
 * distribution. The others are subclasses of
 * @ref NormalGen; they implement various non-inversion
 ...
 * hand, the generic classes  @ref RandomVariateGen and
 * @ref RandomVariateGenInt call directly the
 ...
 * @ref UnuranDiscreteInt for discrete random variates,
 * @ref UnuranContinuous for continuous ones (in one
 * dimension), and  @ref UnuranEmpirical for
 ...
 * `RandomVariateGen.nextDouble` and
 * `RandomVariateGenInt.nextInt` can be invoked as usual
 ...
 * `RandomVariateGen.nextArrayOfDouble` and
 * `RandomVariateGenInt.nextArrayOfInt`.
 */
