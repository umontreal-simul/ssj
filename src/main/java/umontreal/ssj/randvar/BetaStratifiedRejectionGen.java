...
public class BetaStratifiedRejectionGen extends BetaGen {
   ...
   /**
    * Creates a new generator for the distribution `dist`, using the given stream
    * `s` and auxiliary stream `aux`. The auxiliary stream is used when a random
    * number of variates must be drawn from the main stream.
    */
   ...
   /**
    * Same as {@link #BetaStratifiedRejectionGen() BetaStratifiedRejectionGen(s, s,
    * dist)}. The auxiliary stream used will be the same as the main stream.
    */
