 ...
 * Poisson and central chi square generators. It uses the following algorithm:
 * generate a random integer @f$J \sim\mbox{Poisson}(\lambda/2)@f$ from a
 * Poisson distribution, generate a random real @f$X \sim\Gamma(j + \nu/2,
 * 1/2)@f$ from a gamma distribution, then return @f$X@f$. Here @f$\nu@f$ is the
 ...
 * @ref umontreal.ssj.randvar.PoissonTIACGen ). To generate the gamma variates,
