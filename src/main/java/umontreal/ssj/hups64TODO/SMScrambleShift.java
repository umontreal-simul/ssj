 ...
 * performs a striped matrix scrambling @cite vOWE03a and adds a random digital
 * shift. Point set must be a @ref umontreal.ssj.hups.DigitalNet or an
...
public class SMScrambleShift extends RandomShift {
   ...
   /**
    * This method calls
    * umontreal.ssj.hups.DigitalNet.stripedMatrixScramble(RandomStream), then
