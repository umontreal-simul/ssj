...
/**
 * This abstract class describes methods specific to digital sequences. Concrete
 * classes must implement the #extendSequence method that increases the number
 * of points of the digital sequence. Calling the methods #toNet or
