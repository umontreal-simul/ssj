...
/**
 * This class implements a digital net in base 2 starting from a linear feedback
 * shift register generator. It is exactly the same point set as the one defined
 * in the class @ref umontreal.ssj.hups.F2wCycleBasedLFSR. See the description
 ...
 * 
 * @ref umontreal.ssj.hups.F2wCycleBasedLFSR, makes SSJ construct a digital net
 *      in base 2. This is useful if one wants to randomize using one of the
