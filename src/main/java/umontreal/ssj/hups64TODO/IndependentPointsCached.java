 ...
 * uniformly distributed over the @f$s@f$-dimensional unit hypercube. They are
 * enumerated in the order in which they are generated.
 *
...
public class IndependentPointsCached extends CachedPointSet {
   ...
   /**
    * Generates a new set of @f$n@f$ independent points, regardless of what `rand`
