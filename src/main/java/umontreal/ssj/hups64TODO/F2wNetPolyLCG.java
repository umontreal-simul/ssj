...
/**
 * This class implements a digital net in base 2 starting from a polynomial LCG
 * in @f$\mathbb F_{2^w}[z]/P(z)@f$. It is exactly the same point set as the one
 ...
 * @ref umontreal.ssj.hups.F2wCycleBasedPolyLCG, makes SSJ construct a digital
 *      net in base 2. This is useful if one wants to randomize using one of the
 *      randomizations included in the class
...
public class F2wNetPolyLCG extends DigitalNetBase2 {
    ...
    */
   public F2wNetPolyLCG(int type, int w, int r, int modQ, int step, int nbcoeff, int coeff[], int nocoeff[], int dim) {
