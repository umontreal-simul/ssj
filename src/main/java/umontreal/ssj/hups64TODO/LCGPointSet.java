 ...
 * The implementation is done by storing the values of @f$u_i@f$ over the set of
 * all cycles of the recurrence.
 *
...
public class LCGPointSet extends CycleBasedPointSet {
    ...
    * @f$n-1@f$, there are two cycles, the first one containing only 0 and the
    *            second one of period length @f$n-1@f$.
