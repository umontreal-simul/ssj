 ...
 * randomizes a sequence simply by taking a random starting point. For now, this
 * only applies to the Halton sequence, but it could eventually be generalized
 * to other types of sequences. The point set must be an instance of @ref
 * umontreal.ssj.hups.HaltonSequence or an IllegalArgumentException is thrown.
 *
...
public class RandomStart implements PointSetRandomization {
   ...
   /**
    * This method calls umontreal.ssj.hups.HaltonSequence.init(double[]). If `p` is
    * not a @ref umontreal.ssj.hups.HaltonSequence, an IllegalArgumentException is
    * thrown.
    * 
