...
/**
 * Implements a single instance of a weight for search-algorithms for
 * quasi-Monte Carlo point sets as, e.g., those implemented in *LatNet Builder*.
 * The template parameter 'T' indicates the data type of the underlying index.
 * Common choices are integers (e.g. the order for @ref OrderDependentWeights)
 * or
 * 
 * @ref CoordinateSet (e.g. the projection for @ref ProjectionDependentWeights),
 *      etc.
 * 
 * @author florian
 *
