...
/**
 * Class implementing *projection dependent weights.* In this case, weights are
 * assigned to each projection individually. With a view to using this class
 * together with *LatticeBuilder* it is also possible to set weights for the
 * entire collections of projections of the same order via
 * 
...
public class ProjectionDependentWeights extends Weights<CoordinateSet> {
   ...
   /**
    * Adds an order dependent weight to #orderDependentWeights. Duplicate
    * assignments to the same order are taken care of.
    * 
   ...
   /**
    * Assigns an entire list of comparable 'SingleTonWeights' as order dependent
    * weights to #orderDependentWeights.
    * 
    * @param ordWeights list of singleton weights representing the order dependent
    *                   weights.
    */
