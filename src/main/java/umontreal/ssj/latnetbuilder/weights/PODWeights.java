...
/**
 * This class implements so-called product- and order dependent weights (POD
 * weights). As the name suggests, POD weights are composed of @ref
...
public class PODWeights extends Weights {
   ...
   /**
    * Constructor for given #productWeights and #orderDependentWeights is
    * constructed by the default constructor for @ref OrderDependentWeights.
    * 
    * @param pWeights The product weight-component.
    */
   ...
   /**
    * Constructor for given #orderDependentWeights and #productWeights is
    * constructed by the default constructor for @ref ProductWeights.
    * 
    * @param odWeights The order dependent weight-component.
    */
   ...
   /**
    * Adds an order dependent weight by passing the order and the value of the
    * weight.
    * 
   ...
   /**
    * Adds a product weight by passing the coordinate index and the value of the
    * weight.
    * 
