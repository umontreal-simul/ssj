 ...
 * coordinate, i.e., @f$\gamma_{\mathfrak u} = \prod_{j\in\mathfrak
 * u}\gamma_j@f$. Thus, the index of each 'SingletonWeightComparable' is given
 * by an integer (starting at 0 for the first coordinate) and corresponds to one
 * specific coordinate.
 * 
 * @author puchhamf
 *
...
public class ProductWeights extends WeightsComparable<Integer> {
   ...
   /**
    * Constructor for product weights from a list of @ref SingletonWeightComparable
    * indexed by integers indicating the coordinate.
    * 
    * @param weightList list of comparable weights to be set as the product
    *                   weights.
    */
    ...
    * coordinate they are assigned to. Missing weights (i.e. a weight for a
    * coordinates which has not been set and lies between two coordinates, whose
