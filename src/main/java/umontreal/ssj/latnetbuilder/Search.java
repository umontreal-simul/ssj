...
/**
 * Abstract class for the search of highly uniform point sets with LatNet
 * Builder. See the <a href=
 * "http://umontreal-simul.github.io/latnetbuilder/de/db5/cmdtut_summary.html">Summary
 * of Command-Line Options</a> of LatNet Builder for details about the various
...
abstract public class Search {
   ...
   /**
    * Executes the command-line and reads the content of the outputMachine.txt
    * file.
    */
         ...
         try {
            ...
            if (p.exitValue() != 0) {
               ...
               throw new RuntimeException(
                     "LatNet Builder exited with status " + p.exitValue() + "\nCOMMAND LINE: " + cmd + res);
            }
    ...
    * 
    * @param sizeParameter Modulus for lattices and number of points for digital
    *                      nets.
    */
    ...
    * 
    * Gson gson = new Gson(); if
    * (json.contains("\"construction\":\"polynomial\"")){ return
    * gson.fromJson(json, PolynomialLatticeSearch.class); } else if
    * ((json.contains("\"construction\":"))){ return gson.fromJson(json,
    * DigitalNetSearch.class); } else { return gson.fromJson(json,
    * OrdinaryLatticeSearch.class); } }
    */
}