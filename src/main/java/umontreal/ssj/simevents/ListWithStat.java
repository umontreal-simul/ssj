 ...
 * collection of statistics on the sojourn times of objects in the list and on
 * the size of the list as a function of time given by a simulator. The
 * automatic statistical collection can be enabled or disabled for each list, to
 * reduce overhead. This class extends
 * 
 * @ref umontreal.ssj.util.TransformingList and transforms elements into nodes
 *      associating insertion times with elements.
 *
...
public class ListWithStat<E> extends TransformingList<E, ListWithStat.Node<E>> {
    ...
    * simulator and implemented by `nodeList`. The given list is cleared for the
   ...
   /**
    * Constructs a list containing the elements of the specified collection, whose
    * elements are stored into `nodeList` and using the default simulator.
    * 
    * @param nodeList the list containing the nodes
   ...
   /**
    * Constructs a list containing the elements of the specified collection, whose
    * elements are stored into `nodeList`.
    * 
   ...
   /**
    * Constructs a new list with name `name`, internal list `nodeList`, and using
    * the default simulator. This name can be used to identify the list in traces
    * and reports. The given list is cleared for the constructed list to be
    * initially empty.
    * 
    * @param nodeList the list containing the nodes
   ...
   /**
    * Constructs a new list with name `name`, and internal list `nodeList`. This
    * name can be used to identify the list in traces and reports. The given list
    * is cleared for the constructed list to be initially empty.
    * 
    * @param inSim    simulator associate to the current variable
    * @param nodeList the list containing the nodes
    * @param name     name for the list object
    ...
    * `c`, with name `name`, internal list `nodeList`, and using the default
    * simulator. This name can be used to identify the list in traces and reports.
    * 
    * @param nodeList the list containing the nodes
    * @param c        collection containing elements to fill in this list with
    * @param name     name for the list object
   ...
   /**
    * Constructs a new list containing the elements of the specified collection
    * `c`, with name `name`, and internal list `nodeList`. This name can be used to
   ...
   /**
    * Sets the simulator associated with this list. This list should be cleared
   ...
   /**
    * Returns `true` if the list collects statistics about its size and sojourn
    * times of elements, and `false` otherwise. By default, statistical collecting
    * is turned off.
    * 
    ...
    * collection is turned ON, the method creates two statistical probes if they do
    * not exist yet. The first one, of the class @ref Accumulate, measures the
    * evolution of the size of the list as a function of time. It can be accessed
    * by the method #statSize. The second one, of the class @ref
    * umontreal.ssj.stat.Tally and accessible via #statSojourn, samples the sojourn
    * times in the list of the objects removed during the observation period, i.e.,
    * between the last initialization time of this statistical probe and the
    * current time. The method automatically calls #initStat to initialize these
    * two probes. When this method is used, it is normally invoked immediately
    * after calling the constructor of the list.
    * 
    * @exception IllegalStateException if the statistical collection is in the same
    *                                  state as the caller requires
    */
    ...
    * {@link #setStatCollecting() setStatCollecting(true)} and makes an update for
    * the probe on the list size.
    * 
   ...
   /**
    * Returns the statistical probe on the evolution of the size of the list as a
    * function of the simulation time. This probe exists only if
    * {@link #setStatCollecting() setStatCollecting(true)} has been called for this
    * list.
    * 
   ...
   /**
    * Returns the statistical probe on the sojourn times of the objects in the
    * list. This probe exists only if {@link #setStatCollecting()
   ...
   /**
    * Returns a string containing a statistical report on the list, provided that
    * {@link #setStatCollecting() setStatCollecting(true)} has been called before
    * for this list. Even If #setStatCollecting was called with `false` afterward,
    * the report will be made for the collected observations. If the probes do not
    * exist, i.e., #setStatCollecting was never called for this object, an illegal
   ...
   public static class Node<E> {
      ...
      /**
       * Constructs a new node containing element `element` inserted into the list at
       * time `insertionTime`.
       * 
