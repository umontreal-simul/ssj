...
/**
 * An implementation of @ref EventList using the doubly-linked indexed list of
 * Henriksen @cite sKIN86a&thinsp; (see also @cite sFIS01a&thinsp; (p. 207)).
 *
 * Events are stored in a normal doubly-linked list. An additional index array
 * is added to the structure to allow quick access to the events.
 *
