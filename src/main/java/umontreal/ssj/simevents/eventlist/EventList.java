...
public interface EventList extends Iterable<Event> {
	...
	/**
	 * Adds a new event in the event list, according to the time of <tt>ev</tt>. If
	 * the event list contains events scheduled to happen at the same time as
	...
	/**
	 * Same as #add, but adds the new event <tt>ev</tt> immediately before the event
	 * <tt>other</tt> in the list.
	 * 
	 * @param ev    event to be added
	...
	/**
	 * Same as #add, but adds the new event <tt>ev</tt> immediately after the event
	 * <tt>other</tt> in the list.
	 * 
	 * @param ev    event to be added
	...
	/**
	 * Returns the first event in the event list. If the event list is empty,
	 * returns <tt>null</tt>.
	 * 
	 * @return the first event in the event list, or <tt>null</tt> if the list is
	 *         empty
	 */
	 ...
	 * <tt>null</tt>.
	 * 
	 * @return the first event of class <tt>cl</tt>, or <tt>null</tt> if no such
	 *         event exists in the list
	 */
	...
	/**
	 * Returns a list iterator over the elements of the class <tt>Event</tt> in this
	 * list.
	 * 
	 * @return a list iterator over the elements of the class <tt>Event</tt> in this
	 *         list
	 */
	...
	/**
	 * Removes the first event from the event list (to cancel or execute this
	 * event). Returns the removed event. If the list is empty, then <tt>null</tt>
	 * is returned.
	 * 
	 * @return the first event removed from the list, or <tt>null</tt> if the list
	 *         is empty
	 */
