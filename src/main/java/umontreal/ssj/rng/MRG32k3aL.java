...
/**
 * The same generator as @ref MRG32k3a, except here it is implemented with type
 * `long` instead of `double`. (See @ref MRG32k3a for more information.)
 *
...
public class MRG32k3aL extends RandomStreamBase {
   ...
   private static final long A1p0[][] = { { 0L, 1L, 0L }, { 0L, 0L, 1L }, { -810728L, 1403580L, 0L } };
   private static final long A2p0[][] = { { 0L, 1L, 0L }, { 0L, 0L, 1L }, { -1370589L, 0L, 527612L } };
   private static final long A1p76[][] = { { 82758667L, 1871391091L, 4127413238L },
         { 3672831523L, 69195019L, 1871391091L }, { 3672091415L, 3528743235L, 69195019L } };
   private static final long A2p76[][] = { { 1511326704L, 3759209742L, 1610795712L },
         { 4292754251L, 1511326704L, 3889917532L }, { 3859662829L, 4292754251L, 3708466080L } };
   private static final long A1p127[][] = { { 2427906178L, 3580155704L, 949770784L },
         { 226153695L, 1230515664L, 3580155704L }, { 1988835001L, 986791581L, 1230515664L } };
   private static final long A2p127[][] = { { 1464411153L, 277697599L, 1610723613L },
         { 32183930L, 1464411153L, 1022607788L }, { 2824425944L, 32183930L, 2093834863L } };
   ...
   public String toString() {
      ...
      str.append(Cg3 + ", ");
      str.append(Cg4 + ", ");
      str.append(Cg5 + " }" + PrintfFormat.NEWLINE + PrintfFormat.NEWLINE);
