...
public class RandomPermutation {
   ...
   /**
    * Initializes `array` with the first @f$n@f$ positive integers in natural order
    * as <tt>array</tt>@f$[i-1] = i@f$, for @f$i=1,...,n@f$. The size of `array`
    * must be at least @f$n@f$.
    * 
   ...
   /**
    * Similar to {@link #init() init(byte[], int)}. <div class="SSJ-bigskip"></div>
    * 
    * @param array the array to initialize.
    * @param n     number of elements initialized.
    */
   ...
   /**
    * Randomly permutes `array` using `stream`. This method permutes the whole
    * array.
    * 
    ...
    * @f$n@f$ elements, `array[0]` to `array[n-1]`, assuming that @f$k \le n \le@f$
    *         `array.length`. In other words, @f$k@f$ elements are selected at
    *         random without replacement from the first @f$n@f$ array elements and
    *         are placed in the first @f$k@f$ positions, in random order.
    * @param array  the array being shuffled.
   ...
   /**
    * Similar to {@link #shuffle() shuffle(Object[], n, k, RandomStream)}.
    * 
    * @param array  the array being shuffled.
    * @param n      selection amongst the first n elements.
    * @param k      number of elements selected.
