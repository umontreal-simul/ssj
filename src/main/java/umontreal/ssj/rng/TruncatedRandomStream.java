 ...
 * 
 * @f$(a,b)@f$ instead of in @f$(0,1)@f$, where @f$0\le a < b \le1@f$, by using
 *             the contained stream. If `nextDouble` returns @f$u@f$ for the
 *             contained stream, it will return @f$v = a + (b-a)u@f$, which is
 *             uniform over @f$(a,b)@f$, for the truncated stream. The method
 *             `nextInt` returns the integer that corresponds to @f$v@f$ (by
 *             inversion); this integer is no longer uniformly distributed in
 *             general.
 *
