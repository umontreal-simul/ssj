 ...
 * Concrete classes must implement the  #extendSequence method that increases
 * the number of points of the digital sequence. Calling the methods  #toNet
 * or  #toNetShiftCj will transform the digital sequence into a digital net,
 * which has a fixed number of points @f$n@f$.
 *
