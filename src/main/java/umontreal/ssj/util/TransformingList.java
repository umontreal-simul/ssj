 ...
 * This abstract class defines a list containing an inner list of elements of a
 * certain type, and provides facilities to convert these inner elements to
 * outer elements of another type. A concrete subclass simply needs to provide
 * methods for converting between the inner and the outer types.
 * 
