...
public class RatioFunction implements MultivariateFunction {
   ...
   /**
    * Constructs a new ratio function that returns `zeroOverZero` for the special
    * case of @f$0/0@f$. See the #getZeroOverZeroValue method for more information.
   ...
   /**
    * Returns the value returned by #evaluate in the case where the @f$0/0@f$
    * function is calculated. The default value for
    * 
   ...
   /**
    * Sets the value returned by #evaluate for the undefined function @f$0/0@f$ to
    * `zeroOverZero`. See #getZeroOverZeroValue for more information.
    * 
