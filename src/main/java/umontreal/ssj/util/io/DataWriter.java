...
public interface DataWriter {
   ...
   /**
    * Writes a one-dimensional array of strings. Writes an anonymous field if
    * `label` is `null`.
    */
   ...
   /**
    * Writes a one-dimensional array of 32-bit integers (big endian). Writes an
   ...
   /**
    * Writes a one-dimensional array of 32-bit floats (big endian). Writes an
    * anonymous field if `label` is `null`.
    */
   public void write(String label, float[] a) throws IOException;
   ...
   /**
    * Writes a one-dimensional array of 64-bit doubles (big endian). Writes an
    * anonymous field if `label` is `null`.
    */
   public void write(String label, double[] a) throws IOException;
