...
/**
 * Represents a polynomial of degree @f$n@f$ in power form. Such a polynomial is
 * of the form @f[ p(x) = c_0 + c_1x + \cdots+ c_nx^n, @f] where @f$c_0, …,
 * c_n@f$ are the coefficients of the polynomial.
 *
 * <div class="SSJ-bigskip"></div>
 */
public class Polynomial implements MathFunction, MathFunctionWithFirstDerivative, MathFunctionWithDerivative,
...
//         res = i*(coeff[i] + x * res);
    ...
    * integral is of the form @f[ \int p(x)dx = c + c_0x + \frac{c_1 x^2}{2} +
    * \cdots+ \frac{c_n x^{n+1}}{n+1}, @f] where @f$c@f$ is a user-defined
    * constant.
    * 
