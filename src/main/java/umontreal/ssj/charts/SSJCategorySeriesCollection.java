 ...
 * data sets and rendering options, and modify plot color, plot style, and marks
...
public abstract class SSJCategorySeriesCollection {
    ...
    * 
    * @return `CategoryDataset` object associated with the current variable.
    */
    ...
    * 
    * @return `CategoryItemRenderer` object associated with the current variable.
    */
    ...
    * This object determines the chart JFreeChart look, produced by method `view`
    * in class @ref umontreal.ssj.charts.XYChart.
    * 
    ...
    * scaled with the `YShift` and `YScale` parameters. `ymin` and `ymax` represent
    * the chart bounds.
    * 
