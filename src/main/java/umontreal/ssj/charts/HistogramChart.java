...
/**
 * Provides tools to create and manage histograms. Each `HistogramChart` object
 * is linked with an `HistogramSeriesCollection` dataset.
 *
...
public class HistogramChart extends XYChart {
   ...
   /**
    * Initializes a new `HistogramChart` instance with input `data`. `title` is a
    * title, `XLabel` is a short description of the
    * 
    * @f$x@f$-axis, and `YLabel` a short description of the @f$y@f$-axis. The input
    *               parameter `data` represents a collection of observation sets.
    *               Therefore <tt>data</tt>@f$[i], i = 0,…,n-1@f$, is used to
    *               plot the @f$i@f$th histogram.
    ...
    * 
    * @f$x@f$-axis, and `YLabel` a short description of the @f$y@f$-axis. The input
    *               parameter `data` represents an observation set. Only *the
    ...
    * `DoubleArrayList` input parameter represents a collection of observation
    * sets. DoubleArrayList is from the Colt library and is used to store data.
    * 
    * @param title  chart title.
    * @param XLabel Label on @f$x@f$-axis.
    * @param YLabel Label on @f$y@f$-axis.
   ...
   /**
    * Initializes a new `HistogramChart` instance with data arrays contained in
    * each @ref umontreal.ssj.stat.TallyStore object. The input parameter `tallies`
   ...
   /**
    * Initializes a new `HistogramChart` instance with data `data`. The input
    ...
    * The adjacent categories (or bins) are specified as non-overlapping intervals:
    * bin[j] contains the values in the interval [<tt>bound[j]</tt>,
    * <tt>bound[j+1]</tt>], and `count[j]` is the number of such values. Thus the
    * length of `bound` must be equal to the length of `count` plus one: the last
    * value of `bound` is the right boundary of the last bin.
    * 
    * @param title  chart title.
    * @param XLabel Label on @f$x@f$-axis.
    * @param YLabel Label on @f$y@f$-axis.
   ...
   /**
    * Initializes a new `HistogramChart` instance with data arrays contained in
    * each @ref umontreal.ssj.stat.TallyHistogram object. The input parameter
    * `tallies` represents a collection of observation sets. The 2 extra bins at
    * the beginning and at the end of the tallies are not counted nor represented
    * in the chart.
    * 
    * @param title   chart title.
    * @param XLabel  Label on @f$x@f$-axis.
   ...
   /**
    * Synchronizes @f$x@f$-axis ticks to the @f$s@f$-th histogram bins if the
    * number of bins is not larger than 10; otherwise, choose approximately 10
    * ticks.
    * 
