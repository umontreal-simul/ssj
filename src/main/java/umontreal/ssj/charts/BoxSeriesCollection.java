...
/**
 * This class stores data used in a @ref umontreal.ssj.charts.CategoryChart. It
 * also provides complementary tools to draw box-and-whisker plots; for example,
 * one may add or remove plots series and modify plot style. This class is
 * linked with the JFreeChart `DefaultBoxAndWhiskerCategoryDataset` class to
 * store data plots, and linked with the JFreeChart `BoxAndWhiskerRenderer` to
 * render the plots.
 *
...
public class BoxSeriesCollection extends SSJCategorySeriesCollection {
   ...
   /**
    * Creates a new `BoxSeriesCollection` instance with default parameters and
    * input series `data`. Only *the first* `numPoints` of `data` will taken into
    * account.
    * 
   ...
   /**
    * Creates a new `BoxSeriesCollection` instance with default parameters and
    * given data series. The input parameter represents series of point sets.
    * 
   ...
   /**
    * Creates a new `BoxSeriesCollection` instance with default parameters and
    * given data series. The input parameter represents a
   ...
   /**
    * Adds a data series into the series collection. Vector `data` represents a
    * point set.
    * 
    * @param data point sets.
   ...
   /**
    * Adds a data series into the series collection. Vector `data` represents a
    * point set. Only *the first* `numPoints` of `data` will be added to the new
    * series.
    * 
