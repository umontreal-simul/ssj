...
/**
 * A dataset that can be used for creating histograms. This class is inspired
 * from JFreeChart HistogramDataset class, and provides tools to customize
 * histogram bins.
 *
 */
public class CustomHistogramDataset extends AbstractIntervalXYDataset
	...
	/**
	 * Sets the histogram type and sends a @ref DatasetChangeEvent to all registered
	 * listeners.
	 *
	 ...
	 * assigned to the first bin, and any data value greater than maximum will be
	 * assigned to the last bin. Values falling on the boundary of adjacent bins
	 * will be assigned to the higher indexed bin.
	 *
	 * @param key     the series key (<code>null</code> not permitted).
	 ...
	 * assigned to the first bin, and any data value greater than maximum will be
	 * assigned to the last bin. Values falling on the boundary of adjacent bins
	 * will be assigned to the higher indexed bin. Only the first numPoints values
	 * are used.
	 *
	 * @param key       the series key (<code>null</code> not permitted).
	 * @param values    the raw observations.
	...
	/**
	 * Adds a series to the dataset. Values falling on the boundary of adjacent bins
	 * will be assigned to the higher indexed bin.
	 *
	 * @param key    the series key (<code>null</code> not permitted).
	 * @param values the raw observations.
	 ...
	 * histograms, since the renderer will ignore it. But other renderers can use it
	 * (for example, you could use the dataset to create a line chart).
	 *
	 * @param series the series index (in the range <code>0</code> to
	 *               <code>getSeriesCount() - 1</code>).
	 ...
	 * method exists only to support the general form of the {IntervalXYDataset}
	 * interface.
	 *
	 * @param series the series index (in the range <code>0</code> to
	 *               <code>getSeriesCount() - 1</code>).
