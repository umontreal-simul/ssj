...
//         e.printStackTrace();
   ...
   /**
    * Constructor for a new `ContinuousDistChart` instance. It will plot the
    * continuous distribution `dist` over the interval @f$[a,b]@f$, using @f$m+1@f$
    ...
    * displayed before it is returned. The `width` and the `height` of the chart
   ...
   /**
    * Exports a chart of the cdf to a LaTeX source code using PGF/TikZ. This method
