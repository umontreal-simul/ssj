 ...
 * sets and rendering options, and modify plot color, plot style, and marks on
...
public abstract class SSJXYSeriesCollection {
   ...
   /**
    * Returns the @f$x@f$-value at the specified index in the specified series.
    * 
    * @param series required series value.
    * @param index  value’s index.
    * @return @f$x@f$-value at the specified index in the specified series.
    */
   ...
   /**
    * Returns the @f$y@f$-value at the specified index in the specified series.
    * 
    * @param series required series value.
    * @param index  value’s index.
    * @return @f$y@f$-value at the specified index in the specified series.
    */
   ...
   /**
    * Sets the `XYItemRenderer` object associated with the current variable. This
    * object determines the chart JFreeChart look, produced by method `view` in
    * class @ref umontreal.ssj.charts.XYChart.
    * 
    ...
    * represents this data series collection. The original datasets are shifted and
    * scaled with the `XShift`, `YShift`, `XScale` and `YScale` parameters. `xmin`,
    * `xmax`, `ymin` and `ymax` represent the chart bounds.
    * 
