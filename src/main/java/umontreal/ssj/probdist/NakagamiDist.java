...
/**
 * Extends the class @ref ContinuousDistribution for the *Nakagami* distribution
 * with location parameter @f$a@f$, scale parameter @f$\lambda> 0@f$ and shape
 * parameter @f$c > 0@f$. The density is
 * 
 * @anchor REF_probdist_NakagamiDist_eq_fnakagami @f[ f(x) =
 *         \frac{2\lambda^c}{\Gamma(c)} (x-a)^{2c-1} e^{-{\lambda}(x-a)^2}
 *         \qquad\mbox{for } x > a,\tag{fnakagami} @f] @f[ f(x) = 0 \qquad\mbox{
 *         for } x \le a, @f] where @f$\Gamma@f$ is the gamma function.
 *
...
public class NakagamiDist extends ContinuousDistribution {
   ...
   /**
    * Computes and returns the mean @f[ E[X] = a + \frac{1}{\sqrt{\lambda}}\;
    * \frac{\Gamma(c+1/2)}{\Gamma(c)}. @f]
    * 
    * @param a      the location parameter
    * @param lambda the scale parameter
    * @param c      the shape parameter
   ...
   /**
    * Computes and returns the variance @f[ \mbox{Var}[X] = \frac{1}{\lambda}
    * \left[c - \left(\frac{\Gamma(c+1/2)}{\Gamma(c)}\right)^2\right]. @f]
    * 
    * @param a      the location parameter
    * @param lambda the scale parameter
    * @param c      the shape parameter
   ...
   /**
    * Sets the parameters @f$a@f$, @f$\lambda@f$ and @f$c@f$ of this object.
    * 
    * @param a      the location parameter
    * @param lambda the scale parameter
    * @param c      the shape parameter
    ...
    * table is put in regular order: [@f$a@f$, @f$\lambda@f$, @f$c@f$].
    * 
