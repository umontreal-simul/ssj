 ...
 *         the two-sided *Kolmogorov–Smirnov* statistic is defined as @f[ D_n
 *         = \sup_{-\infty\le x \le\infty} |F_n(x) - F(x)| = \max\{D_n^+,
 *         D_n^-\}, @f] where @f$D_n^+@f$ and @f$D_n^-@f$ are the
 *         *Kolmogorov–Smirnov*+ and *Kolmogorov–Smirnov*@f$-@f$ statistics
 *         as defined in equations
 *         {@link REF_probdist_KolmogorovSmirnovPlusDist_eq_DNp DNp} and
 *         {@link REF_probdist_KolmogorovSmirnovPlusDist_eq_DNm DNm} of this
 *         guide. This class implements a high precision version of the
 *         *Kolmogorov–Smirnov* distribution @f$P[D_n \le x]@f$; it is a Java
 *         translation of the @f$C@f$ program written in
...
public class KolmogorovSmirnovDist extends ContinuousDistribution {
    ...
    * =========================================================================
    * 
    * The following implements the Durbin matrix algorithm and was programmed in C
    * by G. Marsaglia, Wai Wan Tsang and Jingbo Wong in C.
    * 
    * I have translated their program in Java. Only small modifications have been
    * made in their program; the most important is to prevent the return of NAN or
    * infinite values in some regions. (Richard Simard)
    * 
    * =========================================================================
    */
    ...
    * 
    * with x_1<x_2,...<x_n a purported set of n independent uniform [0,1) random
    * variables sorted into increasing order. See G. Marsaglia, Wai Wan Tsang and
    * Jingbo Wong, J.Stat.Software, 8, 18, pp 1--4, (2003).
    */
    ...
    * is a translation of the @f$C@f$ program in @cite tMAR03a&thinsp;; according
    * to its authors, it returns 13 decimal digits of precision. It is extremely
    * slow for large @f$n@f$.
    */
