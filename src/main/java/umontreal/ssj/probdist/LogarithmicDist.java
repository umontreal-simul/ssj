 ...
 * distribution. It has shape parameter @f$\theta@f$, where @f$0 < \theta<1@f$.
 * Its mass function is
 * 
 * @anchor REF_probdist_LogarithmicDist_eq_flogar @f[ p(x) =
 *         \frac{-\theta^x}{x\log(1- \theta)} \qquad\mbox{for } x =
 *         1,2,3,…\tag{flogar} @f] Its distribution function is @f[ F(x) =
 *         \frac{-1}{\log(1 - \theta)}\sum_{i=1}^x \frac{\theta^i}{i},
 *         \qquad\mbox{ for } x = 1, 2, 3, … @f] and is 0 for @f$ x\le0@f$.
 *
...
public class LogarithmicDist extends DiscreteDistributionInt {
   ...
   /**
    * Constructs a logarithmic distribution with parameter @f$\theta= @f$ `theta`.
    */
   ...
   /**
    * Estimates the parameter @f$\theta@f$ of the logarithmic distribution using
    ...
    * @f$\hat{\theta}@f$ satisfies the equation (see @cite mEVA00a&thinsp; (page
    *                    122))
    * @f{align*}{ \bar{x}_n = \frac{-\hat{\theta}}{(1 - \hat{\theta}) \ln(1 -
    *             \hat{\theta})}
   ...
   /**
    * Computes and returns the mean @f[ E[X] = \frac{-\theta}{(1 - \theta)\ln(1 -
    * \theta)} @f] of the logarithmic distribution with parameter @f$\theta= @f$
    * `theta`.
    * 
    * @return the mean of the logarithmic distribution @f$E[X] = -\theta/ ((1 -
    *         \theta) ln(1 - \theta))@f$
    */
   ...
   /**
    * Computes and returns the variance @f[ \mbox{Var}[X] = \frac{-\theta(\theta+
    * \ln(1 - \theta))}{[(1 - \theta) \ln(1 - \theta)]^2} @f] of the logarithmic
    * distribution with parameter @f$\theta=@f$ `theta`.
    * 
    * @return the variance of the logarithmic distribution
    * @f$\mbox{Var}[X] = -\theta(\theta+ ln(1 - \theta)) / ((1 - \theta)^2 (ln(1 -
    *                  \theta))^2)@f$
    */
   ...
   /**
    * Computes and returns the standard deviation of the logarithmic distribution
