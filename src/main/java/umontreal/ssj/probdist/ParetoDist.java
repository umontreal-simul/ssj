 ...
 * parameter @f$\beta> 0@f$ @cite tJOH95a&thinsp; (page 574). The density for
 * this type of Pareto distribution is
 * 
 * @anchor REF_probdist_ParetoDist_eq_fpareto @f[ f(x) =
 *         \frac{\alpha\beta^{\alpha}}{x^{\alpha+1}} \qquad\mbox{for }x
 *         \ge\beta, \tag{fpareto} @f] and 0 otherwise. The distribution
 *         function is
 * @anchor REF_probdist_ParetoDist_eq_Fpareto @f[ F(x) = 1 -
 *         \left(\beta/x\right)^{\alpha}\qquad\mbox{for }x\ge\beta,
 *         \tag{Fpareto} @f] and the inverse distribution function is @f[
 *         F^{-1}(u) = \beta(1 - u)^{-1/\alpha} \qquad\mbox{for } 0 \le u <
...
public class ParetoDist extends ContinuousDistribution {
   ...
   /**
    * Constructs a `ParetoDist` object with parameters @f$\alpha=@f$ `alpha`
    * and @f$\beta= 1@f$.
    */
   ...
   /**
    * Estimates the parameters @f$(\alpha,\beta)@f$ of the Pareto distribution
    ...
    * @f{align*}{ \hat{\beta} & = \min_i \{x_i\} \\ \hat{\alpha} & =
    *             \frac{n}{\sum_{i=1}^n
    *             \ln\left(\frac{x_i}{\hat{\beta}\Rule{0.0pt}{5.5pt}{0.0pt}}\right)}.
    * @f} See @cite tJOH95a&thinsp; (page 581).
   ...
   /**
    * Computes and returns the mean @f$E[X] = \alpha\beta/(\alpha- 1)@f$ of the
    * Pareto distribution with parameters @f$\alpha@f$ and
    * 
    * @f$\beta@f$. @return the mean of the Pareto distribution
    */
    ...
    * 
    * @f$\mbox{Var}[X] = \frac{\alpha\beta^2}{(\alpha- 2)(\alpha- 1)}@f$ of the
    *                  Pareto distribution with parameters @f$\alpha@f$ and
    * @f$\beta@f$. @return the variance of the Pareto distribution @f$\mbox{Var}[X]
   ...
   /**
    * Computes and returns the standard deviation of the Pareto distribution with
