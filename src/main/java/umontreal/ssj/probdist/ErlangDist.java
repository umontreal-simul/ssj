 ...
 *             distribution for which the shape parameter @f$k=\alpha@f$ is an
 *             integer.
 *
...
public class ErlangDist extends GammaDist {
   ...
   /**
    * Constructs a `ErlangDist` object with parameters @f$k@f$ = `k`
    * and @f$\lambda=1@f$.
    */
   ...
   /**
    * Estimates the parameters @f$(k,\lambda)@f$ of the Erlang distribution using
    ...
    * regular order: [@f$k@f$, @f$\lambda@f$]. The equations of the maximum
    * likelihood are the same as for the gamma distribution. The @f$k@f$ parameter
    * is the rounded value of the @f$\alpha@f$ parameter of the gamma distribution,
    * and the @f$\lambda@f$ parameter is equal to the
    * 
    ...
    * 
    * @f$k@f$ and @f$\lambda@f$ estimated using the maximum likelihood method based
   ...
   /**
    * Computes and returns the mean, @f$E[X] = k/\lambda@f$, of the Erlang
    * distribution with parameters @f$k@f$ and @f$\lambda@f$.
    * 
    * @return the mean of the Erlang distribution @f$E[X] = k / \lambda@f$
    */
   ...
   /**
    * Computes and returns the variance, @f$\mbox{Var}[X] = k/\lambda^2@f$, of the
    * Erlang distribution with parameters @f$k@f$ and @f$\lambda@f$.
    * 
    * @return the variance of the Erlang distribution @f$\mbox{Var}[X] = k /
    *         \lambda^2@f$
    */
   ...
   /**
    * Computes and returns the standard deviation of the Erlang distribution with
    * parameters @f$k@f$ and @f$\lambda@f$.
    * 
   ...
   /**
    * Sets the parameters @f$k@f$ and @f$\lambda@f$ of the distribution for this
    * object. Non-static methods are computed with a rough target of `d` decimal
    * digits of precision.
    */
    ...
    * is put in regular order: [@f$k@f$, @f$\lambda@f$].
    */
