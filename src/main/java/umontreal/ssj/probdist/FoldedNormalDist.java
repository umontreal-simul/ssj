 ...
 * distribution with parameters @f$\mu\ge0@f$ and @f$\sigma> 0@f$. The density
 * is
 * 
 * @anchor REF_probdist_FoldedNormalDist_eq_fFoldedNormal @f[ f(x) =
 *         \phi\left(\frac{x-\mu}{\sigma}\right) +
 *         \phi\left(\frac{-x-\mu}{\sigma}\right) \qquad\mbox{for } x \ge0,
 *         \tag{fFoldedNormal} @f] @f[ f(x) = 0, \qquad\mbox{ for } x < 0, @f]
...
public class FoldedNormalDist extends ContinuousDistribution {
   ...
   /**
    * Constructs a `FoldedNormalDist` object with parameters @f$\mu=@f$ `mu`
    * and @f$\sigma=@f$ `sigma`.
    */
   ...
   /**
    * Computes and returns the mean @f[ E[X] = \sigma\sqrt{\frac{2}{\pi}}\;
    * e^{-\mu^2/(2\sigma^2)} +
    * \mu \mbox{erf}\left(\frac{\mu}{\sigma\sqrt{2}}\right), @f] where
    * erf@f$(z)@f$ is the error function.
    * 
    * @param mu    the parameter mu
    * @param sigma the parameter sigma
   ...
   /**
    * Computes and returns the variance @f[ \mbox{Var}[X] = \mu^2 + \sigma^2 -
    * E[X]^2. @f]
    * 
    * @param mu    the parameter mu
    * @param sigma the parameter sigma
   ...
   /**
    * Computes the standard deviation of the folded normal distribution with
