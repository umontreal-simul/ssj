...
public class StudentDistQuick extends StudentDist {
    ...
    * Student @f$t@f$-distribution function with @f$n@f$ degrees of freedom. Gives
    * at least 5 decimal digits of precision when @f$n \ge3@f$ (see @cite
    * tHIL70a&thinsp;). Uses exact formulae for
    * 
    * @f$n=1@f$ and @f$n=2@f$.
    */
