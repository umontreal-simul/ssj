...
//========================================================================
   ...
   /**
    * Computes the *Kolmogorov–Smirnov* distribution function @f$u = P[D_n \le
    * x]@f$ with parameter @f$n@f$, using the program described in
    * 
    ...
    * @cite tMAR03a&thinsp; for @f$n \le500@f$, which returns at least 13 decimal
    *       digits of precision. It uses the Pelz-Good asymptotic expansion
    * @cite tPEL76a&thinsp; in the central part of the range for @f$n > 500@f$ and
    *       returns at least 7 decimal digits of precision everywhere for @f$500 <
    *       n \le100000@f$. For @f$n > 100000@f$, it returns at least 5 decimal
    *       digits of precision for all @f$u > 10^{-16}@f$, and a few correct
    *       decimals when @f$u \le10^{-16}@f$. This method is much faster than
    *       method `cdf` of
    * @ref KolmogorovSmirnovDist for moderate or large @f$n@f$.
    ...
    * 
    * @f$P[D_n \ge x]@f$ with parameter @f$n@f$, in a form that is more precise in
    *          the upper tail, using the program described in
    * @cite tSIM11a&thinsp;. It returns at least 10 decimal digits of precision
    *       everywhere for all @f$n \le500@f$, at least 6 decimal digits of
    *       precision for @f$500 < n \le200000@f$, and a few correct decimal digits
    *       (1 to 5) for @f$n > 200000@f$. This method is much faster and more
    *       precise for @f$x@f$ close to 1, than method `barF` of @ref
    *       KolmogorovSmirnovDist for moderate or large @f$n@f$.
    *       Restriction: @f$n\ge1@f$.
    */
