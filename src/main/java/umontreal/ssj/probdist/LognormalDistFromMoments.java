 ...
 * mean @f$m@f$ and the variance @f$v@f$ of the distribution as arguments. The
 * mean and variance of a lognormal random variable with parameters
 * 
 * @f$\mu@f$ and @f$\sigma@f$ are @f$e^{\mu+\sigma^2/2}@f$ and @f$e^{2\mu+
 *           \sigma^2}(e^{\sigma^2} - 1)@f$ respectively, so the parameters are
 *           given by
 * @f$\sigma=\sqrt{\ln(v/m^2+1)}@f$ and @f$\mu=\ln(m) - \sigma^2/2@f$.
 *
