 ...
 * @anchor REF_probdist_HyperbolicSecantDist_eq_fHyperbolicSecant @f[ f(x) =
 *         \frac{1}{2 \sigma} \mbox{ sech}\left(\frac{\pi}{2} \frac{(x -
 *         \mu)}{\sigma}\right) \tag{fHyperbolicSecant} @f] The distribution
 *         function is given by
 * @anchor REF_probdist_HyperbolicSecantDist_eq_FHyperbolicSecant @f[ F(x) =
 *         \frac{2}{\pi} \tan^{-1}\left[\exp{\left(\frac{\pi}{2} \frac{(x -
 *         \mu)}{\sigma}\right)}\right] \tag{FHyperbolicSecant} @f] The
 *         non-static versions of the methods `cdf`, `barF`, and `inverseF` call
...
public class HyperbolicSecantDist extends ContinuousDistribution {
   ...
   /**
    * Computes the distribution function of the hyperbolic secant distribution with
   ...
   /**
    * Computes the complementary distribution function of the hyperbolic secant
   ...
   /**
    * Estimates the parameters @f$(\mu, \sigma)@f$ of the hyperbolic secant
    ...
    *         [@f$\mu@f$, @f$\sigma@f$]. The estimate of the parameters is given by
    ...
    * parameters @f$\mu@f$ and @f$\sigma@f$ estimated using the maximum likelihood
   ...
   /**
    * Computes and returns the mean @f$E[X] = \mu@f$ of the hyperbolic secant
    * distribution with parameters @f$\mu@f$ and @f$\sigma@f$.
    * 
    * @return the mean of the hyperbolic secant distribution @f$E[X] = \mu@f$
    */
    ...
    * hyperbolic secant distribution with parameters @f$\mu@f$ and
    * 
    * @f$\sigma@f$. @return the variance of the hyperbolic secant distribution
