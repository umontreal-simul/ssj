 ...
 * @anchor REF_probdist_UniformDist_eq_funiform @f[ f(x) = 1/(b-a) \qquad\mbox{
 *         for } a\le x\le b \tag{funiform} @f] and 0 elsewhere. The
 *         distribution function is
 * @anchor REF_probdist_UniformDist_eq_cdfuniform @f[ F(x) = (x-a)/(b-a)
 *         \qquad\mbox{ for } a\le x\le b \tag{cdfuniform} @f] and its inverse
 *         is
 * @anchor REF_probdist_UniformDist_eq_cdinvfuniform @f[ F^{-1}(u) = a + (b -
 *         a)u \qquad\mbox{for }0 \le u \le1. \tag{cdinvfuniform} @f]
...
public class UniformDist extends ContinuousDistribution {
   ...
   /**
    * Constructs a uniform distribution over the interval @f$(a,b) = (0,1)@f$.
    */
   public UniformDist() {
      setParams(0.0, 1.0);
   }
    ...
    * {@link REF_probdist_UniformDist_eq_cdfuniform cdfuniform} ).
    */
    ...
    * {@link REF_probdist_UniformDist_eq_cdinvfuniform cdinvfuniform} ).
    */
   ...
   /**
    * Estimates the parameter @f$(a, b)@f$ of the uniform distribution using the
    ...
    * @f{align*}{ \hat{a} & = \min_i \{x_i\} \\ \hat{b} & = \max_i \{x_i\}.
    * @f} See @cite sLAW00a&thinsp; (page 300).
    ...
    * 
    * @f$a@f$ and @f$b@f$ estimated using the maximum likelihood method based on
    ...
    * 
    * @return the mean of the uniform distribution @f$E[X] = (a + b) / 2@f$
    */
   ...
   /**
    * Computes and returns the variance @f$\mbox{Var}[X] = (b - a)^2/12@f$ of the
    * uniform distribution with parameters @f$a@f$ and @f$b@f$.
    * 
    * @return the variance of the uniform distribution @f$\mbox{Var}[X] = (b - a)^2
    *         / 12@f$
    */
   ...
   /**
    * Computes and returns the standard deviation of the uniform distribution with
    * parameters @f$a@f$ and @f$b@f$.
    * 
    ...
    * table is put in regular order: [@f$a@f$, @f$b@f$].
    */
