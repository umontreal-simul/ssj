 ...
 * it to an interval @f$[a,b]@f$, where @f$a@f$ and @f$b@f$ can be finite or
 * infinite. If the original density and distribution function are
 * 
 * @f$f_0@f$ and @f$F_0@f$, the new ones are @f$f@f$ and @f$F@f$, defined by @f[
 *           f(x) = \frac{f_0(x)}{F_0(b) - F_0(a)} \qquad\mbox{ for } a\le x\le
 *           b @f] and @f$f(x)=0@f$ elsewhere, and @f[ F(x) =
 *           \frac{F_0(x)-F_0(a)}{F_0(b)-F_0(a)} \qquad\mbox{ for } a\le x\le
 *           b. @f] The inverse distribution function of the truncated
 *           distribution is @f[ {F^{-1}}(u) = F_0^{-1}(F_0(a) + (F_0(b) -
 *           F_0(a))u) @f] where @f$F_0^{-1}@f$ is the inverse distribution
...
public class TruncatedDist extends ContinuousDistribution {
   ...
   /**
    * Constructs a new distribution by truncating distribution `dist` to the
    * interval @f$[a,b]@f$. Restrictions: @f$a@f$ and @f$b@f$ must be finite.
    */
   ...
   /**
    * Returns the value of @f$F_0(b) - F_0(a)@f$, the area under the truncated
    * density function.
    */
   ...
   /**
    * Sets the parameters `dist`, @f$a@f$ and @f$b@f$ for this object. See the
    ...
    * table is put in order:
    * [@f$a@f$, @f$b@f$, @f$F_0(a)@f$, @f$F_0(b)@f$, @f$F_0(b) - F_0(a)@f$].
    */
