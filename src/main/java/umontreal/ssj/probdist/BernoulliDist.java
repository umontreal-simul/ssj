 ...
 * @anchor REF_probdist_BernoulliDist_eq_fmass_bernoulli @f[ f(x) =
 *         \begin{cases} 1 - p, \qquad & \text{if $x = 0$;} \\ p, & \text{if $x
 *         = 1$;} \tag{fmass-bernoulli} \\ 0, & \text{otherwise.}
 *         \end{cases} @f] Its distribution function is
 * @anchor REF_probdist_BernoulliDist_eq_cdf_bernoulli @f[ F(x) = \begin{cases}
 *         0, & \text{if $x < 0$;} \\ 1 - p, \qquad & \text{if $0 \le x < 1$;}
 *         \tag{cdf-bernoulli} \\ 1, & \text{if $x \ge1$.} \end{cases} @f]
...
public class BernoulliDist extends DiscreteDistributionInt {
   ...
   /**
    * Returns the Bernoulli probability @f$f(x)@f$ with parameter @f$p@f$ (see eq.
    * ( {@link REF_probdist_BernoulliDist_eq_fmass_bernoulli fmass-bernoulli} )).
    */
   ...
   /**
    * Returns the Bernoulli distribution function @f$F(x)@f$ with parameter @f$p@f$
    * (see eq. ( {@link REF_probdist_BernoulliDist_eq_cdf_bernoulli cdf-bernoulli}
    * )).
    */
   ...
   /**
    * Estimates the parameters @f$p@f$ of the Bernoulli distribution using the
   ...
   /**
    * Computes the variance @f$\mbox{Var}[X] = p(1 - p)@f$ of the Bernoulli
