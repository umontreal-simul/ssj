 ...
 * MCExperimentDensity and RQMCExperimentDensity, among others, to run the
 * model. The interface assumes that the output from the model is a random
...
public interface MonteCarloModelDensityKnown extends MonteCarloModelDouble {
   ...
   /**
    * Recovers the cumulative density function (cdf) of \f$X\f$ evaluated at
    * \f$x\f$
    * 
