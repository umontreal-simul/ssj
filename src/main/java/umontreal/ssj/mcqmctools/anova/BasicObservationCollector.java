...
/**
 * Does nothing but counting the total number of observations. Provides useful
 * functionality for deriving classes.
 *
 * Deriving classes overriding methods, e.g. init() or add(), must call their
 * parent's versions.
 *
 */
