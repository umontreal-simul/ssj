...
public class RQMCExperiment extends MonteCarloExperiment {
    ...
    * observations in `statReps`. These `m` observations are usually independent if
    * the randomizations used in the RQMC point set `prqmc` are independent.
    */
   ...
   /**
    * Simulate `m` replications and return the `m` RQMC average observations in
    * `statReps`. Here the QMC point set `p` and its randomization `rand` are
    * specified directly.
    */
   ...
   /**
    * Similar to `simulReplicatesRQMCDefaultReport`, but this one makes a
    * comparison with another estimator whose variance per run is
    * `variancePerRunMC` and which took a time `secondPerRunMC` per run to compute.
    * These values may come from a previous MC experiment. Returns a report as a
    * `String`.
    */
   ...
   // probes.
   /**
    * This method first performs a MC experiment to estimate the variance and CPU
    * time per run, then invokes `simulReplicatesRQMCDefaultReportCompare` and
    * returns a printable report that compares MC with RQMC.
    */
   ...
   /**
    * In this version, the statistical collectors are created internally, so they
    ...
    * 
    * @param model    the underlying model which is simulated.
    * @param prqmc    the RQMC-point set used.
    * @param m        number of independent replications.
    * @param statReps statistical container collecting the obtained estimates.
    */
    ...
    * 
    * @param model        the underlying model which is simulated.
    * @param p            the point set used.
    * @param rand         the point set randomization used.
    * @param m            number of independent replications.
    * @param statRepsList statistical container collecting the obtained estimates.
    */
    ...
    * @param m            number of independent replications.
    * @param statRepsList statistical container collecting the obtained estimates.
    * @param data         array in which all the observations are stored.
    */
   public static void simulReplicatesRQMC(MonteCarloModelDoubleArray model, RQMCPointSet prqmc, int m,
   ...
   /**
    * Same as
    * {@link #simulReplicatesRQMC(MonteCarloModelDoubleArray, RQMCPointSet, int, ListOfTallies, double[][][])},
    * but with the point set and the randomization passed separately.
    * 
    * @param model        the underlying model which is simulated.
    * @param p            the QMC-point set used.
    * @param rand         the point set randomization used.
    * @param m            number of independent replications.
    * @param statRepsList statistical container collecting the obtained estimates.
    * @param data         array in which all the observations are stored.
