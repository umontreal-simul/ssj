 ...
 * multiplier @f$a@f$, the points are defined by @f[ \mathbf{u}_i = (i/n)(1, a,
 * a^2, …, a^{s-1}) \bmod1 @f] for @f$i=0,…,n-1@f$.
 *
...
public class SearcherKorobov extends Searcher {
   ...
   /**
    * Exhaustive search to find the best Korobov lattice (i.e. with the smallest
    * discrepancy) in dimension @f$s@f$. The search runs exhaustively over all
    * values @f$ a = 2, 3, …, (n-1)@f$, where
    * 
    * @f$a@f$ is the generator of the lattice. The method returns the best value
    *         found for the discrepancy.
    */
    ...
    * of @f$a@f$ *relatively prime* to @f$n@f$ are considered.
    */
    ...
    * discrepancy) in dimension @f$s@f$. @f$k@f$ random values @f$a@f$ are examined
    * as generator of the lattice. The @f$a@f$ takes values over the integers @f$ a
    * = 2, 3, …, (n-1)@f$. The method returns the best value found for the
    * discrepancy.
    */
   ...
   /**
    * Returns the generator @f$a@f$ of the lattice which gave the best value of the
