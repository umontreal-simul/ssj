 ...
 * {@link REF_discrepancy_DiscShiftBaker1_baker1 baker1} )], but uses
 * multi-precision real numbers.
 *
 * **No method are implemented yet for this class.**
 *
 * <strong>Only the subclass `BigDiscShiftBaker1Lattice` has implemented methods
 * to compute the discrepancy.</strong>
 *
...
public class BigDiscShiftBaker1 extends BigDiscrepancy {
   ...
   /**
    * Constructor for a lattice of @f$n@f$ points in @f$s@f$ dimensions, with
    * weights @f$\gamma_r = @f$ `gamma[r-1]`, @f$r = 1,2, …, s@f$. The @f$n@f$
