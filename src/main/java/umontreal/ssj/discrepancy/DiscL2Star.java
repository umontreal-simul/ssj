 ...
 * discrepancy</strong> @f$\mathcal{D}_2^*(\mathcal{P})@f$ for a set 
 * of @f$n@f$ points @f$\mathcal{P}@f$ @cite rWAR72a, @cite rWAR95a,
 ...
 * parallelepiped anchored at the origin as Vol@f$([0,t)) = t_1 t_2 ... t_s@f$.
 ...
 * equivalent to
 * the @anchor REF_discrepancy_DiscL2Star_eq_cramermises
 *  @f[
