...
public class VarianceGammaProcessDiffPCASymmetricalBridge extends VarianceGammaProcessDiffPCA {
    ...
    *         only one @ref umontreal.ssj.rng.RandomStream here which is used for
    *         the two inner @ref GammaProcessPCASymmetricalBridge ’s. The other
    *         parameters are set as in @ref VarianceGammaProcessDiff.
    */
   public VarianceGammaProcessDiffPCASymmetricalBridge(double s0, double theta, double sigma, double nu,
         RandomStream stream) {
