 ...
 * bridge transformation of the @ref BrownianMotionPCA instead of a sequential
 * transformation.
 *
...
public class GammaProcessPCABridge extends GammaProcessPCA {
    ...
    * \mathtt{s0}@f$. The same stream is used to generate the gamma and beta random
    * numbers. All these numbers are generated by inversion in the following order:
    * the first uniform random number generated is used for the gamma and the
    * other @f$d-1@f$ for the beta’s.
    */
