...
public class TestAsianRQMCSeries extends AsianGBM implements MonteCarloModelDouble {
   ...
   public TestAsianRQMCSeries(double r, double sigma, double strike, double s0, int s, double[] zeta) {
   ...
   public static void main(String[] args) throws IOException {
      ...
      TestAsianRQMCSeries model = new TestAsianRQMCSeries(0.05, 0.5, 100.0, 100.0, s, zeta);
      ...
      System.out.println(
            MonteCarloExperiment.simulateRunsDefaultReportStudent(model, n, new MRG32k3a(), statValue, 0.95, s));
      ...
      int[] a = { 149, 275, 857, 1731, 2431, 6915, 12545, 19463, 50673, 96407, 204843, 443165, 768165 };
      ...
      System.out.println((experSeries.toPgfDataTable("Korobov+baker")).drawPgfPlotSingleCurve("Korobov+baker", "axis",
            3, 4, 2, "", "marks=*"));
