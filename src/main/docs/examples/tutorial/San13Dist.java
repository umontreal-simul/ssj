 ...
 * distribution of the length T of the shortest path and make a histogram. This
 * program is very specific to this example and uses a very naive way to compute
 * the shortest path, by enumerating all six paths!
 */
