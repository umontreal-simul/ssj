...
/**
 * Here we compute the empirical distribution of the CMC estimator. MAKES NO
 * SENSE !!!!!!!!!!!
 */
...
public class San13CMCDist extends San13CMC {
   ...
   public static void main(String[] args) throws IOException {
      ...
      MonteCarloExperiment.simulateRunsDefaultReportStudent(san, n, new LFSR113(), statT, 0.95, 4);
      statT.quickSort();
