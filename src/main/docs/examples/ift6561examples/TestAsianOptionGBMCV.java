...
public class TestAsianOptionGBMCV {
   ...
   public static void main(String[] args) throws IOException {
      ...
      System.out.println(MonteCarloExperiment.simulateRunsDefaultReportStudent(asian, n, noise, statValueMC));

      // Extract positive payoffs, put them in collector statValuePosMC, and print
      // report.
      ...
      double fractionZero = 1.0 - (double) statValuePosMC.numberObs() / (double) n;
      ...
      HistogramChart hist = new HistogramChart("Distribution of positive discounted payoff", "Payoff", "Frequency",
            statValuePosMC.getArray(), statValuePosMC.numberObs());
