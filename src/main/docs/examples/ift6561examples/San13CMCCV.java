...
public class San13CMCCV extends San13Prob {
   ...
   /**
    * Applies a vector of control variables to an estimator. The tally x contains
    * the observations used to estimate the output average while the array of
    * tallies c contains the observations of the control variates. The third array,
    * ec, contains the known expectations of the control variates. The length c and
    * ec should be equal while x, and c should contain the same number of
    * observations.
    *
