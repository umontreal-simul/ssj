...
public class ISChart1 {
   ...
   private static double[][] isExpon1(double lambda, double T, double xmin, double xmax, int numPoints) {
      double x, z, v;
   ...
   private static double[][] isExpon3(double lambda, double T, double xmin, double xmax, int numPoints) {
      double x, z, v;
      double[][] points = new double[2][numPoints];
   ...
   private static double[][] isBinomial(int n, int na, double p, double xmin, double xmax, int numPoints) {
      double q, z, v, w, sum;
...
//      System.out.println (chart.toLatex (8, 5));
      ...
      /*
       * points = isBinomial (20, 15, 0.25, 0.25, 0.98, 150); flat = constant (0.20,
       * 1.0, 1.0); chart = new XYLineChart (null, "q", "ratio", points, flat);
