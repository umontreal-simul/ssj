...
public class OldAsianRQMC extends AsianOption {
   ...
   public void simulateQMC(int m, PointSet p, PointSetRandomization rand, RandomStream noise, Tally statQMC) {
   ...
   public static void main(String[] args) {
      ...
      StochasticProcess process = new GeometricVarianceGammaProcess(s0, r, new VarianceGammaProcessDiff(0, theta, sigma,
            v, new GammaProcessSymmetricalBridge(0, r, v, stream), new GammaProcessSymmetricalBridge(0, r, v, stream)));
      ...
      int a[] = { 1, 6229, 2691, 3349, 5893, 7643, 7921, 7055, 4829, 5177, 5459, 4863, 4901, 2833, 2385, 3729, 981, 957,
            4047, 1013, 1635, 2327, 7879, 2805, 2353, 1081, 3999, 879, 5337, 7725, 4889, 5103 };
      ...
      System.out.println("QMC with Sobol point set with " + n + " points and affine matrix scramble:\n");
