...
/**
 * Estimates the value of a callable bond using the uncallable bond as a control
 * variate.
 */
public class CallableBondCV extends CallableBond {
   ...
   /**
    * @return a {@code ListOfTalliesWithCV} which has its beta parameter set from
    *         the simulations, without trial runs.
    */
   ...
   public static void main(String[] args) {
      ...
      System.out.println(
            "corresponding 95% CI half-width = " + (1.96 * stdDevWithCV[0] / Math.sqrt((double) nSimulations)));
