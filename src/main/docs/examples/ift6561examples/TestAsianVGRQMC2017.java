...
public class TestAsianVGRQMC2017 {
   ...
   public static void main(String[] args) {
      ...
      /*
       * Note that VarianceGammaProcessAlternate is not yet in SSJ. We need a general
       * class that sample any process with subordinator (with random clock) in an
       * alternate way. Can be implemented as a wrapper.
       */
      StochasticProcess spBGSS = new GeometricVarianceGammaProcess(s0, r, new VarianceGammaProcessAlternate(0.0,
            new BrownianMotion(0.0, mu, sigma, noise), new GammaProcess(0.0, 1.0, nu, noise)));

      StochasticProcess spBGBS = new GeometricVarianceGammaProcess(s0, r, new VarianceGammaProcessAlternate(0.0,
            new BrownianMotionBridge(0.0, mu, sigma, noise), new GammaProcessSymmetricalBridge(0.0, 1.0, nu, noise)));
      ...
      int a1[] = { 1, 6229, 2691, 3349, 5893, 7643, 7921, 7055, 4829, 5177, 5459, 4863, 4901, 2833, 2385, 3729, 981,
            957, 4047, 1013, 1635, 2327, 7879, 2805, 2353, 1081, 3999, 879, 5337, 7725, 4889, 5103 };
      ...
      // MonteCarloExperiment.simulateRunsDefaultReport(asian, n, noise, statValue,
      // timer);
       ...
       * asian.setProcess(spBGSS);
       * RQMCExperiment.simulReplicatesRQMCDefaultReportCompare (asian, m, pSobol,
       * randShift, noise, statRQMC, varMC, secondsMC);
       * RQMCExperiment.simulReplicatesRQMCDefaultReportCompare (asian, m, pSobol,
       * randLMS, noise, statRQMC, varMC, secondsMC);
       * RQMCExperiment.simulReplicatesRQMCDefaultReportCompare (asian, m, pKor,
       * randShift, noise, statRQMC, varMC, secondsMC);
       * RQMCExperiment.simulReplicatesRQMCDefaultReportCompare (asian, m, pKorBaker,
       * randShift, noise, statRQMC, varMC, secondsMC);
       * RQMCExperiment.simulReplicatesRQMCDefaultReportCompare (asian, m, pLat1,
       * randShift, noise, statRQMC, varMC, secondsMC);
       * RQMCExperiment.simulReplicatesRQMCDefaultReportCompare (asian, m, pLat1Baker,
       * randShift, noise, statRQMC, varMC, secondsMC);
       * 
       * // Brownian gamma bridge sampling System.out.println
       ...
       * randShift, noise, statRQMC, varMC, secondsMC);
       * 
       * // Double gamma bridge sampling System.out.println
      ...
      RQMCExperiment.simulFDReplicatesRQMC(asian, asian2, delta, pSobol, randLMS, m, statRQMC);
