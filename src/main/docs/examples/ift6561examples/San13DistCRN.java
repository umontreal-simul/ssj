...
public class San13DistCRN extends San13Dist {
   ...
   public static void main(String[] args) throws IOException {
      ...
      System.out.printf("Variance per run: %9.5g%n", statCRN.variance() * n);
      System.out.println(statCRNPos.report(0.95, 4));
      statIRN.setConfidenceIntervalStudent();
      System.out.println(statIRN.report(0.95, 4));
      System.out.printf("Variance per run: %9.5g%n", statIRN.variance() * n);
      System.out.printf("Variance ratio: %9.5g%n", statIRN.variance() / statCRN.variance());

      HistogramChart hist = new HistogramChart("Dist. of positive Delta, CRN", "Values of Delta", "Frequency",
            statCRNPos.getArray(), statCRNPos.numberObs());
      ...
      hist = new HistogramChart("Distribution of Delta IRN", "Values of Delta", "Frequency", statIRN.getArray(), n);
