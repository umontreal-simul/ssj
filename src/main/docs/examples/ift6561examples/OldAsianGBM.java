...
public class OldAsianGBM implements MonteCarloModelDouble {
   ...
   // times.
   public OldAsianGBM(double r, double sigma, double strike, double s0, int d, double[] obsTimes) {
      this.strike = strike;
      this.d = d;
   ...
   public static void main(String[] args) {
      ...
      int n = 1000000;
      MonteCarloExperiment.simulateRunsDefaultReportStudent(asian, n, new MRG32k3a(), statValue, 0.95, 4);
   }
}
