...
public class TestAsianVGRQMC {
   ...
   public static void main(String[] args) {
      ...
      System.out
            .println(MonteCarloExperiment.simulateRunsDefaultReportStudent(asian, n, noise, statValue, 0.95, 4, timer));
      ...
      asian.setProcess(spBGSS);
      System.out.println(RQMCExperiment.simulReplicatesRQMCDefaultReportCompare(asian, pSobol, randShift, m, statRQMC,
            varMC, secondsMC));
      System.out.println(RQMCExperiment.simulReplicatesRQMCDefaultReportCompare(asian, pSobol, randLMS, m, statRQMC,
            varMC, secondsMC));
      System.out.println(RQMCExperiment.simulReplicatesRQMCDefaultReportCompare(asian, pKor, randShift, m, statRQMC,
            varMC, secondsMC));
      ...
      System.out.println(RQMCExperiment.simulReplicatesRQMCDefaultReportCompare(asian, pLat1, randShift, m, statRQMC,
            varMC, secondsMC));
