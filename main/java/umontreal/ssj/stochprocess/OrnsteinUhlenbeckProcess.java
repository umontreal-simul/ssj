 ...
 * @anchor REF_stochprocess_OrnsteinUhlenbeckProcess_eq_ornstein
 * @f[
 ...
 * technique @cite fGLA04a&thinsp; (p. 110)
 * @anchor REF_stochprocess_OrnsteinUhlenbeckProcess_eq_ornstein_seq
 * @f[
 ...
 * @f]
 * where @f$Z_j \sim N(0,1)@f$. The time intervals @f$t_j - t_{j-1}@f$ can be
 * arbitrarily large.
 *
...
public class OrnsteinUhlenbeckProcess extends StochasticProcess {
    ...
    * value @f$X(t_0) =@f$ `x0`. The normal variates @f$Z_j@f$ will be
