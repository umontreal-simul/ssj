 ...
 * that performs a striped matrix scrambling and adds a random digital shift.
...
public class SMScrambleShift extends RandomShift {
   ...
   /**
    * This method calls
    * umontreal.ssj.hups.DigitalNet.stripedMatrixScramble(RandomStream),
    * then  umontreal.ssj.hups.DigitalNet.addRandomShift(RandomStream). If
    * `p` is not a  @ref umontreal.ssj.hups.DigitalNet, an
    * IllegalArgumentException is thrown.
